...
public class Tests {
	...
	//must be able to return consecutive int pids when os.reg() method is called starting from 0
	...
	class ProcessSimThread2 extends Thread {
		...
		//Constructor stores reference to os for use in run()
		ProcessSimThread2(OS os){
			this.os = os;
		} 
	...
	// Single Process, Single Processor, Single Priority Queue
	public void ur2_example_test(){
		...
		//Create one process simulation threads:
	...
	//UR5 – Multiple Processes, Single Processors, Multiple Priority Queues
	public void ur5_example_test() {
		...
		String[] expected = { "pid=0, session=0", "pid=1, session=0", "pid=0, session=1", "pid=1, session=1",
				"pid=0, session=2", "pid=1, session=2", "pid=2, session=0", "pid=2, session=1", "pid=2, session=2" };
	...
	//Multiple Processes, Multiple Processors, Multiple Priority Queues
